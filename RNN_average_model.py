...
class RNNModel(AttributionModel):
    ...
    def process_model_confusion_matrix(self):
        ...
        pkl_file = open('../data/batch_data/C50/data_test_bundle_seq.pkl', 'rb')
        batch_list = pickle.load(pkl_file)
        pkl_file.close()
    ...
    def train_model(self):
        ...
        parameter='hs'
        date='0319'
        training_history_txt_filename='results/training_history'+level+'_'+parameter+'_'+dataset+'_'+date  +'.txt'
